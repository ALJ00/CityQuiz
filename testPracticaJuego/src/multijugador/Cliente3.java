...
public class Cliente3 {
    ...
    private com.company.Jugador jugador;
    private String opcion;
    private BufferedReader lecturaTeclado;

    public Cliente3() throws IOException, ClassNotFoundException {
        ...
        jugador = new com.company.Jugador(name,ape,ed,nik,pass);
        ...
        do{
            ...
            switch (opcion){
                ...
                case "b":
                    ...
                    com.company.Jugador jug = new com.company.Jugador();
